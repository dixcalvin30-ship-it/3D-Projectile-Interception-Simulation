...
Kalman Positional Variance with iterations

![Kalman Positional Variance with iterations](PositionVariance.png)


Kalman Velocity Variance with iterations

![Kalman Velocity Variance with iterations](VelocityVariance.png)


Projectile Interception

![Projectile Interception](projectile.png)
